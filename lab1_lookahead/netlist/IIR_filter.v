...
module IIR_filter ( CLK, RST_n, DIN, VIN, b0, b1, b2, a1, DOUT, VOUT );
  ...
  DFFR_X1 regX0_Q_reg_6_ ( .D(regX0_n21), .CK(CLK), .RN(RST_n), .Q(din_del[6]), 
        .QN(regX0_n14) );
  NAND2_X1 regU_U17 ( .A1(u[6]), .A2(q1), .ZN(regU_n7) );
  OAI21_X1 regU_U16 ( .B1(regU_n15), .B2(q1), .A(regU_n7), .ZN(regU_n23) );
  NAND2_X1 regU_U15 ( .A1(u[5]), .A2(q1), .ZN(regU_n6) );
  OAI21_X1 regU_U14 ( .B1(regU_n14), .B2(q1), .A(regU_n6), .ZN(regU_n22) );
  NAND2_X1 regU_U13 ( .A1(u[4]), .A2(q1), .ZN(regU_n5) );
  OAI21_X1 regU_U12 ( .B1(regU_n13), .B2(q1), .A(regU_n5), .ZN(regU_n21) );
  NAND2_X1 regU_U11 ( .A1(u[3]), .A2(q1), .ZN(regU_n4) );
  OAI21_X1 regU_U10 ( .B1(regU_n12), .B2(q1), .A(regU_n4), .ZN(regU_n20) );
  NAND2_X1 regU_U9 ( .A1(u[2]), .A2(q1), .ZN(regU_n3) );
  OAI21_X1 regU_U8 ( .B1(regU_n11), .B2(q1), .A(regU_n3), .ZN(regU_n19) );
  NAND2_X1 regU_U7 ( .A1(u[1]), .A2(q1), .ZN(regU_n2) );
  OAI21_X1 regU_U6 ( .B1(regU_n10), .B2(q1), .A(regU_n2), .ZN(regU_n18) );
  NAND2_X1 regU_U5 ( .A1(q1), .A2(u[0]), .ZN(regU_n1) );
  OAI21_X1 regU_U4 ( .B1(regU_n9), .B2(q1), .A(regU_n1), .ZN(regU_n17) );
  NAND2_X1 regU_U3 ( .A1(u[7]), .A2(q1), .ZN(regU_n8) );
  OAI21_X1 regU_U2 ( .B1(regU_n16), .B2(q1), .A(regU_n8), .ZN(regU_n24) );
  ...
  NAND2_X1 regsum_U17 ( .A1(sum1[6]), .A2(regsum_n22), .ZN(regsum_n38) );
  OAI21_X1 regsum_U16 ( .B1(regsum_n31), .B2(regsum_n22), .A(regsum_n38), .ZN(
        regsum_n24) );
  NAND2_X1 regsum_U15 ( .A1(sum1[5]), .A2(regsum_n22), .ZN(regsum_n39) );
  OAI21_X1 regsum_U14 ( .B1(regsum_n32), .B2(regsum_n23), .A(regsum_n39), .ZN(
        regsum_n25) );
  NAND2_X1 regsum_U13 ( .A1(sum1[4]), .A2(regsum_n22), .ZN(regsum_n40) );
  OAI21_X1 regsum_U12 ( .B1(regsum_n33), .B2(regsum_n22), .A(regsum_n40), .ZN(
        regsum_n26) );
  NAND2_X1 regsum_U11 ( .A1(sum1[3]), .A2(regsum_n22), .ZN(regsum_n41) );
  OAI21_X1 regsum_U10 ( .B1(regsum_n34), .B2(regsum_n22), .A(regsum_n41), .ZN(
        regsum_n27) );
  NAND2_X1 regsum_U9 ( .A1(sum1[2]), .A2(regsum_n22), .ZN(regsum_n42) );
  OAI21_X1 regsum_U8 ( .B1(regsum_n35), .B2(regsum_n22), .A(regsum_n42), .ZN(
        regsum_n28) );
  NAND2_X1 regsum_U7 ( .A1(sum1[1]), .A2(regsum_n22), .ZN(regsum_n43) );
  OAI21_X1 regsum_U6 ( .B1(regsum_n36), .B2(regsum_n22), .A(regsum_n43), .ZN(
        regsum_n29) );
  NAND2_X1 regsum_U5 ( .A1(regsum_n23), .A2(sum1[0]), .ZN(regsum_n44) );
  OAI21_X1 regsum_U4 ( .B1(regsum_n37), .B2(regsum_n22), .A(regsum_n44), .ZN(
        regsum_n30) );
  ...
  NAND2_X1 regY_U17 ( .A1(y[6]), .A2(regY_n25), .ZN(regY_n44) );
  OAI21_X1 regY_U16 ( .B1(regY_n36), .B2(regY_n26), .A(regY_n44), .ZN(regY_n28) );
  NAND2_X1 regY_U15 ( .A1(y[5]), .A2(regY_n25), .ZN(regY_n45) );
  OAI21_X1 regY_U14 ( .B1(regY_n37), .B2(regY_n25), .A(regY_n45), .ZN(regY_n29) );
  NAND2_X1 regY_U13 ( .A1(y[4]), .A2(regY_n25), .ZN(regY_n46) );
  OAI21_X1 regY_U12 ( .B1(regY_n38), .B2(regY_n25), .A(regY_n46), .ZN(regY_n30) );
  NAND2_X1 regY_U11 ( .A1(y[3]), .A2(regY_n25), .ZN(regY_n47) );
  OAI21_X1 regY_U10 ( .B1(regY_n39), .B2(regY_n25), .A(regY_n47), .ZN(regY_n31) );
  NAND2_X1 regY_U9 ( .A1(y[2]), .A2(regY_n25), .ZN(regY_n48) );
  OAI21_X1 regY_U8 ( .B1(regY_n40), .B2(regY_n25), .A(regY_n48), .ZN(regY_n32)
         );
  NAND2_X1 regY_U7 ( .A1(regY_n26), .A2(y[0]), .ZN(regY_n50) );
  OAI21_X1 regY_U6 ( .B1(regY_n42), .B2(regY_n26), .A(regY_n50), .ZN(regY_n34)
         );
  ...
  INV_X1 mult_85_U136 ( .A(b2[9]), .ZN(mult_85_n192) );
  INV_X1 mult_85_U135 ( .A(u_del_vec2[5]), .ZN(mult_85_n181) );
  INV_X1 mult_85_U134 ( .A(u_del_vec2[4]), .ZN(mult_85_n182) );
  INV_X1 mult_85_U133 ( .A(u_del_vec2[3]), .ZN(mult_85_n185) );
  INV_X1 mult_85_U132 ( .A(b2[10]), .ZN(mult_85_n191) );
  INV_X1 mult_85_U131 ( .A(b2[8]), .ZN(mult_85_n193) );
  INV_X1 mult_85_U130 ( .A(b2[7]), .ZN(mult_85_n194) );
  INV_X1 mult_85_U129 ( .A(b2[5]), .ZN(mult_85_n196) );
  ...
  INV_X1 mult_78_U139 ( .A(b1[9]), .ZN(mult_78_n192) );
  INV_X1 mult_78_U138 ( .A(b1[10]), .ZN(mult_78_n191) );
  INV_X1 mult_78_U137 ( .A(u_del_vec[6]), .ZN(mult_78_n179) );
  INV_X1 mult_78_U136 ( .A(u_del_vec[1]), .ZN(mult_78_n189) );
  INV_X1 mult_78_U135 ( .A(u_del_vec[5]), .ZN(mult_78_n181) );
  INV_X1 mult_78_U134 ( .A(u_del_vec[4]), .ZN(mult_78_n182) );
  INV_X1 mult_78_U133 ( .A(u_del_vec[3]), .ZN(mult_78_n185) );
  INV_X1 mult_78_U132 ( .A(u_del_vec[2]), .ZN(mult_78_n187) );
  INV_X1 mult_78_U131 ( .A(b1[8]), .ZN(mult_78_n193) );
  INV_X1 mult_78_U130 ( .A(b1[7]), .ZN(mult_78_n194) );
  INV_X1 mult_78_U129 ( .A(b1[5]), .ZN(mult_78_n196) );
  ...
  INV_X1 mult_73_U139 ( .A(b0[9]), .ZN(mult_73_n192) );
  INV_X1 mult_73_U138 ( .A(b0[10]), .ZN(mult_73_n191) );
  INV_X1 mult_73_U137 ( .A(u_del_vec[6]), .ZN(mult_73_n179) );
  INV_X1 mult_73_U136 ( .A(u_del_vec[1]), .ZN(mult_73_n189) );
  INV_X1 mult_73_U135 ( .A(u_del_vec[5]), .ZN(mult_73_n181) );
  INV_X1 mult_73_U134 ( .A(u_del_vec[4]), .ZN(mult_73_n182) );
  INV_X1 mult_73_U133 ( .A(u_del_vec[3]), .ZN(mult_73_n185) );
  INV_X1 mult_73_U132 ( .A(u_del_vec[2]), .ZN(mult_73_n187) );
  INV_X1 mult_73_U131 ( .A(b0[8]), .ZN(mult_73_n193) );
  INV_X1 mult_73_U130 ( .A(b0[7]), .ZN(mult_73_n194) );
  INV_X1 mult_73_U129 ( .A(b0[5]), .ZN(mult_73_n196) );
  ...
  INV_X1 mult_68_U139 ( .A(a1[9]), .ZN(mult_68_n192) );
  INV_X1 mult_68_U138 ( .A(a1[10]), .ZN(mult_68_n191) );
  INV_X1 mult_68_U137 ( .A(u_del_vec[6]), .ZN(mult_68_n179) );
  INV_X1 mult_68_U136 ( .A(u_del_vec[1]), .ZN(mult_68_n189) );
  INV_X1 mult_68_U135 ( .A(u_del_vec[5]), .ZN(mult_68_n181) );
  INV_X1 mult_68_U134 ( .A(u_del_vec[4]), .ZN(mult_68_n182) );
  INV_X1 mult_68_U133 ( .A(u_del_vec[3]), .ZN(mult_68_n185) );
  INV_X1 mult_68_U132 ( .A(u_del_vec[2]), .ZN(mult_68_n187) );
  INV_X1 mult_68_U131 ( .A(a1[8]), .ZN(mult_68_n193) );
  INV_X1 mult_68_U130 ( .A(a1[7]), .ZN(mult_68_n194) );
  INV_X1 mult_68_U129 ( .A(a1[5]), .ZN(mult_68_n196) );
