...
analyze -f vhdl -lib WORK ../src/SPECIAL_FUNCT/ControlBlock_ABSV.vhd
...
elaborate RISC_V -arch behavior -lib WORK > ./RISC_V_ABS_elaborate.txt
uniquify
link
...
ungroup -all -flatten
compile
report_timing > ./timing_ABS_10.txt
report_area > ./area_ABS_10.txt

change_names -hierarchy -rules verilog
write_sdf ../netlist/RISC_V_ABS_syn.sdf
write -f verilog -hierarchy -output ../netlist/RISC_V_ABS_syn.v
write_sdc ../netlist/RISC_V_ABS_syn.sdc
